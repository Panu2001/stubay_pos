...
<head>
    ...
    <title>Customer Display - {{ \App\Models\Setting::get('store_name', 'Store') }}</title>
        ...
        <div class="flex justify-between items-center mb-4 pb-3 border-b border-gray-100 shrink-0">
            <div class="flex items-center space-x-3">
                @if(\App\Models\Setting::get('store_logo'))
                    <img src="{{ Storage::url(\App\Models\Setting::get('store_logo')) }}" class="h-10 w-auto" alt="Logo">
                @endif
                <div>
                    <h1 class="text-xl font-black tracking-tight text-gray-900">{{ \App\Models\Setting::get('store_name', 'Anantha Multi Shop') }}</h1>

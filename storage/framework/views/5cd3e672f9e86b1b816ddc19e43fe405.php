...
<head>
    ...
    <title>Cash Entry #<?php echo e($entry->id); ?></title>
    <style>
        @page { margin: 0; }
        @media print {
...
<body>
    <div class="receipt text-sm text-black">
        <h2 class="text-center text-xl font-bold mb-1"><?php echo e(\App\Models\Setting::get('store_name', 'Store Name')); ?></h2>
        <p class="text-center" style="font-size: 14px; margin-bottom: 5px;">CASH TRANSACTION VOUCHER</p>
        
        <div class="divider"></div>
        
        <p style="margin: 5px 0;"><strong>Date:</strong> <?php echo e($entry->created_at->format('Y-m-d H:i:s')); ?></p>
        <p style="margin: 5px 0;"><strong>Voucher #:</strong> CE-<?php echo e(str_pad($entry->id, 5, '0', STR_PAD_LEFT)); ?></p>
        <p style="margin: 5px 0;"><strong>User:</strong> <?php echo e($entry->user->name); ?></p>
        
        <div class="divider"></div>
        
        <div class="flex justify-between" style="margin: 10px 0;">
            <span class="font-bold">TYPE:</span>
            <span class="font-bold"><?php echo e($entry->type === 'in' ? 'CASH IN (DEPOSIT)' : 'CASH OUT (WITHDRAWAL)'); ?></span>
        </div>
        
        <div class="flex justify-between" style="margin: 10px 0;">
            <span class="font-bold">AMOUNT:</span>
            <span class="font-bold" style="font-size: 18px;"><?php echo e(\App\Models\Setting::get('currency', '$')); ?> <?php echo e(number_format($entry->amount, 2)); ?></span>
        </div>

        <div class="divider"></div>
        
        <p><strong>Reason:</strong></p>
        <p style="margin-bottom: 20px;"><?php echo e($entry->reason); ?></p>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($entry->notes): ?>
            ...
            <p style="margin-bottom: 20px; font-size: 12px; color: #444;"><?php echo e($entry->notes); ?></p>
...
<?php /**PATH C:\Users\kanes\OneDrive\Documents\pos\resources\views\cash-entry-receipt.blade.php ENDPATH**/ ?>
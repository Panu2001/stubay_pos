<div class="pos-lend-history-page">
    ...
    <?php
        $totalLends = (float) $lends->sum('total_amount');
        $totalPaid = (float) $lends->sum('paid_amount');
        $outstanding = (float) $lends->sum(fn ($lend) => $lend->remaining_amount);
        $openLends = $lends->where('status', '!=', 'paid')->count();
    ?>

    <div class="pos-lend-history-summary">
        <div class="pos-lend-history-stat">
            <span>Total Lends</span>
            <strong><?php echo e($currency); ?><?php echo e(number_format($totalLends, 2)); ?></strong>
        </div>
        <div class="pos-lend-history-stat">
            <span>Total Paid</span>
            <strong><?php echo e($currency); ?><?php echo e(number_format($totalPaid, 2)); ?></strong>
        </div>
        <div class="pos-lend-history-stat">
            <span>Outstanding</span>
            <strong><?php echo e($currency); ?><?php echo e(number_format($outstanding, 2)); ?></strong>
        </div>
        <div class="pos-lend-history-stat">
            <span>Open Lends</span>
            <strong><?php echo e($openLends); ?></strong>
        </div>
    </div>
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $lends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr>
                                ...
                                <td><?php echo e($lend->order?->order_number ?? 'No linked order'); ?></td>
                                <td>
                                    <div class="pos-lend-history-items">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $lend->order?->items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                ...
                                <td class="<?php echo e($lend->remaining_amount > 0 ? 'pos-lend-history-remaining' : 'pos-lend-history-paid'); ?>">
                                    <?php echo e($currency); ?><?php echo e(number_format((float) $lend->remaining_amount, 2)); ?>

                                </td>
                                <td>
                                    <span class="pos-lend-history-badge <?php echo e($lend->status === 'paid' ? 'is-paid' : ''); ?>">
                                        <?php echo e(str($lend->status)->replace('_', ' ')->title()); ?>
...
<?php /**PATH C:\Users\kanes\OneDrive\Documents\pos\resources\views\filament\resources\customer-lend-history.blade.php ENDPATH**/ ?>